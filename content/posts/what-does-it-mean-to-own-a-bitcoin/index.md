...
The answer to that certainly deserves another article but just understand that when you make a transaction it does not get added into the blockchain immediately. 
...
The mining nodes receive lots of transaction information and store them in their computer. The task of a miner is to put the transactions in the blockchain as a new block. This process of placing a block into the blockchain is called **Mining**. Mining bitcoin requires making a lot of autmoated calculations and only those miners with very powerful mining devices can have a chance at successfully mining a block. Miners compete against each other to put a block into the blockchain. When a miner successfully mines a block, he/she gets some amount of BTC as a reward called a [**Block Reward**](https://www.investopedia.com/terms/b/block-reward.asp).
